	...
	<div class="background-container">
		...
		<div class="rbox">
			...
			<div class="quiz-container">
				<form id="quizForm">
					...
					<div class="question">
						<h3>2. Ce eveniment a marcat escaladarea violenței împotriva evreilor în noaptea de 9 noiembrie
							1938?</h3>
					...
					<div class="question">
						<h3>3. În ce an a început cel de-al Doilea Război Mondial, eveniment care a intensificat
							persecuția asupra evreilor?</h3>
					...
					<div class="question">
						...
						<label><input type="radio" name="q6" value="correct"> Exterminarea și exploatarea
							deținuților</label>
						<label><input type="radio" name="q6" value="wrong"> Recrearea socială a deținuților</label>
					</div>

					<div class="question">
						<h3>7. Ce țară a fost invadată de Germania în 1939, declanșând astfel cel de-al Doilea Război
							Mondial?</h3>
					...
					<div class="question">
						<h3>8. Cum se numește întâlnirea de la Wannsee, unde s-a discutat implementarea planului de
							exterminare?</h3>
					...
					<div class="question">
						...
						<label><input type="radio" name="q10" value="correct"> Romi, persoane cu dizabilități,
							homosexuali și opozanți politici</label>
						<label><input type="radio" name="q10" value="wrong"> Doar opozanți politici</label>
					</div>

					<div class="question">
						<h3>11. Care a fost unul dintre mijloacele principale de transport utilizate pentru deportarea
							evreilor către lagăre?</h3>
					...
					<div class="question">
						...
						<label><input type="radio" name="q13" value="correct"> Un program de exterminare a evreilor din
							Polonia ocupată</label>
						<label><input type="radio" name="q13" value="wrong"> Un plan de evacuare pentru civili</label>
						<label><input type="radio" name="q13" value="wrong"> Un program de reeducare a
							prizonierilor</label>
					</div>

					<div class="question">
						<h3>14. Care dintre următoarele lagăre a fost un lagăr de exterminare operat de naziști în
							Polonia?</h3>
					...
					<div class="question">
						<h3>15. Ce a reprezentat eliberarea lagărelor de către forțele aliate la sfârșitul celui de-al
							Doilea Război Mondial?</h3>
						<label><input type="radio" name="q15" value="wrong"> Începerea unui nou regim de
							opresiune</label>
						<label><input type="radio" name="q15" value="correct"> Sfârșitul suferinței și începutul
							reconstrucției pentru supraviețuitori</label>
						<label><input type="radio" name="q15" value="wrong"> Reintegrarea evreilor în rândul
							naziștilor</label>
					</div>
		...
		<div class="docs-container">
			...
			<div class="sub-section">
				<p style="color: #c67171;">Test din Holocaust</p>
			</div>
		</div>
	</div>
	<script>
