	...
	<div class="background-container">
		...
		<div class="rbox">
			...
			<div class="text-container">
				<div class="ftext">În paralel cu ghetoizarea, regimul nazist a desfășurat campanii de exterminare masivă
					...
					evrei – jumătate copii – au fost masacrați într-o singură zi​.</div>
				<div class="stext">Einsatzgruppen au acționat adesea cu sprijinul unor localnici colaboratori sau al
					...
					dintre membrii simpli au revenit la viața civilă fără a răspunde pentru crimele comise.</div>
		...
		<div class="docs-container">
			...
			<div class="sub-section">
				<p style="color: #c67171;">Einsatzgruppen</p>
			</div>
