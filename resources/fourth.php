	...
	<div class="background-container">
		...
		<div class="rbox">
			...
			<div class="text-container">
				<div class="ftext">După ocuparea Poloniei în 1939, politica nazistă anti-evreiască a intrat într-o nouă
					...
					a gloanțelor paznicilor.</div>
				<div class="stext">Între 1940 și 1942, naziștii au înființat sute de ghetouri în Polonia ocupată și în
					...
					era moartea, iar bagajele erau confiscate.</div>
				<div class="stext">Confruntați cu perspectiva exterminării, unii evrei din ghetouri au ales să reziste
					...
					Białystok, Minsk, Târnogrod etc.), însă niciuna nu a putut opri mașinăria genocidară nazistă​.</div>
				<div class="stext">În final, planul naziștilor a fost de a șterge orice urmă a acestor enclave. La 21
					...
					rezistență) în fața unui regim genocidar.</div>
		...
		<div class="docs-container">
			...
			<div class="sub-section">
				<p style="color: #c67171;">Ghetourile și deportările</p>
			</div>
